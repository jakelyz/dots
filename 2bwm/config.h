 ...
 *6)emptycol         */
static const char *colors[] = {"#f0e8d8","#7d5b99","#5e8d87","#a54242","#cc6953","#2c2b2a","#2c2b2a"};
...
static const uint8_t borders[] = {3,5,3,2};
...
static const char *terminal[] = {"/home/jakelyz/gentoo/usr/bin/st", NULL };
///--Custom foo---///
